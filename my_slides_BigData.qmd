---
title: "Análisis de la precariedad económica juvenil en España (2004-2024)"  #- título
website:
  title: "Análisis de la precariedad económica juvenil en España (2004-2024)"
date: 2026-01-02              #- ISO8601 YYYY-MM-DD format 
date-format: short
format: 
  revealjs:
    theme: simple
...
## Introducción {background-color="#f3f4f6"}
...
::: {.column width="40%"}
![](https://thumbs.dreamstime.com/b/spanish-economy-financial-graph-national-flag-overlay-trading-charts-display-market-data-analysis-growth-indicators-396777290.jpg?w=992){.r-stretch style="border-radius: 15px; box-shadow: 5px 5px 15px rgba(0,0,0,0.3);"}
:::
:::
